 ...
 * @since 9.2
 */
public class ClusteredLockImplSolution implements ClusteredLock {
   private static final Log log = LogFactory.getLog(ClusteredLockImplSolution.class, Log.class);
   ...
   public ClusteredLockImplSolution(String name,
