...
[id='rest_v2_list_principals_by_role']
= Listing principals by role
List the principal names with a role for all security realms that can enumerate users (`properties`, `ldap`)
