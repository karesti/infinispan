...
public interface Cache<K, V> extends BasicCache<K, V>, BatchingCache, FilteringListenable<K, V> {
   ...
   /**
    * Overloaded {@link ConcurrentMap#computeIfAbsent(Object, Function)} with Infinispan {@link SerializableFunction}
    *
   ...
   /**
    * Overloaded {@link ConcurrentMap#computeIfPresent(Object, BiFunction)} with Infinispan {@link SerializableBiFunction}
    *
    * @param key, the key to be computed
   ...
   /**
    * Overloaded {@link ConcurrentMap#compute(Object, BiFunction)} with Infinispan {@link SerializableBiFunction}
    *
    * @param key, the key to be computed
    * @param remappingFunction, mapping function to be appliyed to the key
